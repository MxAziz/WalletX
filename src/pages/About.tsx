...
export default function About() {
     ...
     const values = [
          ...
          },
          {
               ...
               description:
                    "Your success is our success. We build lasting relationships based on trust and mutual growth.",
          ...
          },
          {
               ...
               description:
                    "We prioritize the protection of your data with industry-leading security measures.",
          ...
          },
          {
               ...
               title: "Global Impact",
               description:
                    "Making a positive difference in communities worldwide through our products and services.",
     ...
     return (
          <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900">
               ...
               <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-800 dark:via-indigo-800 dark:to-purple-900 text-white">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 py-24 md:py-32">
                         <div className="text-center max-w-4xl mx-auto">
                              ...
                              <p className="text-xl md:text-2xl text-blue-100 dark:text-blue-200 mb-8 leading-relaxed">
                                   ...
                                   technology that transforms ideas into
                                   reality.
                              </p>
                              <div className="flex flex-wrap gap-4 justify-center">
                                   <a
                                        href="/contact"
                                        className="px-8 py-4 bg-white text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transform hover:scale-105 transition-all shadow-lg"
                                   >
                                        Get in Touch
                                   </a>
                                   <a
                                        href="#story"
                                        className="px-8 py-4 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-lg hover:bg-white/30 transform hover:scale-105 transition-all border border-white/30"
                                   >
                                        Our Story
                                   </a>
                              </div>
                    ...
                    <div
                         className="absolute bottom-20 right-10 w-32 h-32 bg-pink-300/20 rounded-full blur-xl animate-pulse"
               ...
               <div className="relative -mt-16 max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                         {stats.map((stat, index) => (
                              <div
                                   key={index}
                                   className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 text-center transform hover:scale-105 transition-all"
                              >
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                         <div>
                              ...
                              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                   Founded in 2020, we started with a simple yet
                                   powerful vision: to create technology that
                                   makes a real difference in people's lives.
                                   What began as a small team of passionate
                                   innovators has grown into a global company
                                   serving thousands of customers worldwide.
                              </p>
                              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                                   Every day, we're inspired by the challenges
                                   our customers face and the opportunities we
                                   have to solve them. Our journey is just
                                   beginning, and we're excited about what the
                                   future holds.
                              </p>
                    ...
                    <div className="max-w-7xl mx-auto px-4">
                         <div className="text-center mb-16">
                              ...
                              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                                   Our core values guide everything we do and
                                   shape the culture we've built.
                              </p>
                         </div>
                         ...
                         <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                              {values.map((value, index) => (
                                   ...
                                   >
                                        <div
                                             className={`w-16 h-16 rounded-xl bg-gradient-to-br ${value.color} flex items-center justify-center text-white mb-4 transform ${activeValue === index ? "scale-110 rotate-6" : ""} transition-all`}
                                        >
                                             {value.icon}
                                        </div>
